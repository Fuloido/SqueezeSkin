...
applets.SVGAsmallSkin.SVGAsmallSkinApplet
Fork from applets.WQVGAsmallSkin.WQVGAsmallSkinApplet

=head1 DESCRIPTION

This applet implements a small print skin for 1024x768 (or maybe better later) resolution
Fork from applets.WQVGAsmallSkin.WQVGAsmallSkinApplet
Modified by Mikaël P.
...
local log                    = require("jive.utils.log").logger("applet.SVGAsmallSkin")
...
local imgpath = "applets/SVGAsmallSkin/images/"
...
function param(self)
		...
		radialClock = {
			hourTickPath     = 'applets/SVGAsmallSkin/images/Clocks/Radial/radial_ticks_hr_on.png',
			minuteTickPath   = 'applets/SVGAsmallSkin/images/Clocks/Radial/radial_ticks_min_on.png',
		},
...
--------- ICONBAR ---------
	...
	local volumeBarWidth = 768 -- screenWidth - (transport controls + volume controls + dividers + border around volume bar)
